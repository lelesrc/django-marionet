...
Marionet for Django. Marionet is a portlet that operates with a remote web app.

== Install requirements
Django 1.2 should be installed to the system.
Older versions need modifications to +test/settings.py+.
...
The test portal consists of one view, /demo
Start the server
  $ make runserver
Open http://localhost:8000/demo in the browser.
