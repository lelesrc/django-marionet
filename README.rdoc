...
Install django-portlets via easy_install:
...
Run the make command
  make portlets
to download and update the source from mercurial at bitbucket. For this you need to install the Mercurial client.
